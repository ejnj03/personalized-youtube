...
export const HomeIcon = () => (
  <svg
    ...
    width='24'
    height='24'
    stroke='var(--muted-fg, #b3b3b3)'
    fill='var(--muted-fg, #b3b3b3)'
    strokeWidth='0'
  >
...
export const MicrophoneIcon = () => (
  <svg
    ...
    viewBox='0 0 16 16'
    className='hoverable-icon'
    style={{ ...SongExtraControlStyle, fill: 'currentcolor' }}
  >
...
export const AddedToLibrary = (props: any) => (
  <svg
    ...
    width='24'
    height='24'
    stroke='var(--accent, #1cb955)'
    fill='var(--accent, #1cb955)'
    strokeWidth='0'
    {...props}
  >
